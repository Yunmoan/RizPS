...
## 已知问题
### WARN：当前版本无法处理/SDKCheckLogin.do 请求，可能会出现 验证失败（2010） 报错，请等待修复
...
在打开游戏后，请<font color="00dd00">一直使用游客登陆，忽视所有</font>让你绑定账号或重试账号登陆的提示，若弹出请选择与继续游客登陆相关的选项。iOS可能会报错账号密码错误，点击√然后点击登入按钮即可

玩够了记得把手机上的代理设置<font color="00dd00">恢复原状</font>，否则会导致无法正常联网，比如Android，直接关闭HTTP代理即可，而iOS，关闭Shadowrocket并将配置恢复默认即可

## 游戏报错解决

### 注意：在遇到任何问题时，请都仔细检查index.js与proxy_config.py是否已按上方README中的说明设置正确，最好是仔细重看一遍README，再根据下面推荐的方案去解决，若实在不行，再尝试卸载游戏重装

Rizline尚未在你所在的地区提供服务，敬请期待！

> 请检查是否已按正确步骤操作此README上方的 “绕过玩家区域验证” ，并测试在手机浏览器中是否能正常访问`www.baidu.com`和`www.google.com`
